---
title: 'Project 2: Language Diversity'
author: "Blessing Anoroh"
date: "March 1, 2024"
output: html_document
---

## Load Packages and Create CSV
...
```{r}
summary_by_continent <- language_diversity %>%
  group_by(Continent) %>%
  summarise(mean_diversity = mean(Langs),
            median_diversity = median(Langs),
            min_diversity = min(Langs),
            max_diversity = max(Langs))

# Print the summary
print(summary_by_continent)

## Plot by Continents 
ggplot(language_diversity, aes(x = Continent, y = Langs, fill = Continent)) +
  geom_boxplot() +
  labs(title = "Language Diversity by Continent",
       x = "Continent",
...
<b> <font size=4>
Based on the analysis the continent Oceania has the most language diversity compared to the other continents maxing at 862 languages.
</b> </font>
